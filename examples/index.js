...
class CanvasRenderer {
  ...
  renderBody(body, ctx) {
    var R = new Mat22(body.rotation);
    var x = body.position;
    var h = Vec2.mulSV(0.5, body.width);
    var v1 = Vec2.add(x, Mat22.mulMV(R, new Vec2(-h.x, -h.y)));
    var v2 = Vec2.add(x, Mat22.mulMV(R, new Vec2(h.x, -h.y)));
    var v3 = Vec2.add(x, Mat22.mulMV(R, new Vec2(h.x, h.y)));
    var v4 = Vec2.add(x, Mat22.mulMV(R, new Vec2(-h.x, h.y)));
    var o = Vec2.add(x, Mat22.mulMV(R, new Vec2(h.x, 0)));
    ctx.beginPath();
...
class Edges {
  constructor() {
    _defineProperty(this, "inEdge1", void 0);

    _defineProperty(this, "outEdge1", void 0);

    _defineProperty(this, "inEdge2", void 0);

    _defineProperty(this, "outEdge2", void 0);
...
class ClipVertex {
  constructor() {
    ...
    _defineProperty(this, "fp", void 0);
...
class Contact {
  constructor() {
    ...
    _defineProperty(this, "separation", void 0);

    _defineProperty(this, "Pn", void 0);

    _defineProperty(this, "Pt", void 0);

    _defineProperty(this, "Pnb", void 0);

    _defineProperty(this, "massNormal", void 0);

    _defineProperty(this, "massTangent", void 0);

    _defineProperty(this, "bias", void 0);
...
function Collide(contacts, bodyA, bodyB) {
  ...
  var normal = dA.x > 0 ? RotA.col1 : Vec2.neg(RotA.col1);
...
var delta = 1 / 30;
var world = new World(new Vec2(0, 40), 20);
